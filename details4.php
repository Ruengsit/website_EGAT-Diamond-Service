...
<body>
    ...
    <div class="news-container">
        <h1 style="font-size: 40px;  margin-bottom: 15px; font-weight: bold; text-align: center;">
            The team of design engineers and technical production team of the Flexxfast by EDS DC charger have selected high-quality equipment that meets European standards.
        </h1> 
        <div class="news1">
            <p style="font-size: 20px; text-align: center;">
            On Friday, November 29, 2024, at 1:00 PM, EGAT Diamond Service Co., Ltd. had the opportunity to welcome a team from Thai Honda Co., Ltd. (Thailand) and Asian Honda Motor Co., Ltd. (Thailand).
            During the visit, both parties participated in a meeting to discuss business opportunities and the growing number of electric vehicle users in the current market.
            Following the discussion, EGAT Diamond Service’s executives led the Honda team on a factory tour, showcasing the production, research, and development areas for EV chargers. They also introduced safety equipment, demonstrated usage procedures, and shared various technical insights in detail.
            With Flexxfast by EDS, the company is committed to supporting EV technology advancements and strengthening Honda’s business growth in the future.
            </p>
            <img src="./image/1.jpg" alt="ev">
        </div>
    </div>   
    </main>
    <script>
