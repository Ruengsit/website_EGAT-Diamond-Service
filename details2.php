...
<body>
    ...
    <div class="news-container">
        ...
        <div class="news1">
            ...
            <img src="./image/ev12.jpg" alt="ev12">
        </div>
        <p style="font-size: 20px; text-align: center;">
            The Flexxfast by EDS DC Charger comes with Dynamic Power Balancing as a standard function in every unit. 
            Additionally, EDS has tested it by simultaneously charging two electric vehicles with different power demands, 
            such as a BMW iX Drive 40 and an EGAT electric bus or a Tesla and an MG, without any issues.
            This ensures that the Flexxfast by EDS DC Charger delivers maximum safety and efficiency, providing the best value for all users.
        </p>
        <div class="news0">
            <img src="./image/ev13.jpg" alt="ev13"><br><br>
            <p style="font-size: 20px; text-align: center;">
                You can be confident that various electric vehicle models, from city cars to supercars, have undergone real charging tests with the Flexxfast DC Charger.
            </p>
        </div>
    </div>
    </main>
