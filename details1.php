...
<body>
    ...
    <div class="news-container">
        <h1 style="font-size: 40px;  margin-bottom: 15px; font-weight: bold; text-align: center;">
            The Governor of the Electricity Generating Authority of Thailand, along with the executives and delegation, visited EGAT Diamond Service Co., Ltd. (EDS).
        </h1> 
        <div class="news1">
            <img src="./image/news1.jpg" alt="news1">
        </div>
        <p style="font-size: 20px; text-align: center;">
            On Friday, August 16, 2024, Mr.Thepprattan Thepphitak (P'Kui), the Governor of the Electricity Generating Authority of Thailand (EGAT), 
            along with his executives and delegation, visited EGAT Diamond Service Co., Ltd. (EDS).
        </p>
        <div class="news0">
            <img src="./image/news6.jpg" alt="news6"><br><br>
            <img src="./image/news8.jpg" alt="news8"><br><br>
            <img src="./image/news9.jpg" alt="news9"><br><br>
            <img src="./image/news7.jpg" alt="news7"><br><br>
        </div>
    </div>
    </main>
    <script>
